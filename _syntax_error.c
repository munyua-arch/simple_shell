 ...
 *
 * Return: an index of error. 0 if there are no
 * errors
 */
 ...
 * @i: index
 *
 * Return: 1 if an error occurs. 0 if there is no error.
 */
 ...
 * @input: input string
 *
 * Return: 1 if an error occurs. 0 if an error does not occur
 */
