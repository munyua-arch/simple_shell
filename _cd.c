...
/**
 * cd_to - a void function that changes to a directory
 * given by the user
 *
...
/**
 * cd_previous - a null function that changes to the previous directory
 *
 * @datash: data relevant (environ)
 * Return: 0 if successful
 */
...
/**
 * cd_to_home - a function that changes home directory
 *
 * @datash: data relevant (environ)
